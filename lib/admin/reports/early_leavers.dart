...
import 'package:time_and_attendance/admin/provider/early_leavers.dart';
...
class EarlyLeaver extends StatefulWidget {
...
class _EarlyLeaver extends State<EarlyLeaver> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: <Widget>[
          ...
          ChangeNotifierProvider<EarlyLeaversProvider>(
            create: (context) => EarlyLeaversProvider(),
            child: Consumer<EarlyLeaversProvider>(
              builder: (context, provider, child) {
                if (provider.data == null) {
                  provider.getData(context, "1", widget.date);
                ...
                return SingleChildScrollView(
                  ...
                  child: SingleChildScrollView(
                    child: DataTable(
                      ...
                      rows: provider.data.earlyleavers
                          .map((data) =>
