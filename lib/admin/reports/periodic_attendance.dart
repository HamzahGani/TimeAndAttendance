...
import 'package:time_and_attendance/admin/provider/periodic_attendance.dart';
...
class PeriodicAttendance extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _PeriodicAttendance();
  }
}

class _PeriodicAttendance extends State<PeriodicAttendance> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: <Widget>[
          ...
          ChangeNotifierProvider<PeriodicAttendanceProvider>(
            create: (context) => PeriodicAttendanceProvider(),
            child: Consumer<PeriodicAttendanceProvider>(
