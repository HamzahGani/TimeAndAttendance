...
import 'package:time_and_attendance/admin/provider/late_comer.dart';
...
class LateComer extends StatefulWidget {
...
class _LateComer extends State<LateComer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: <Widget>[
          ...
          ChangeNotifierProvider<LateComerProvider>(
            create: (context) => LateComerProvider(),
            child: Consumer<LateComerProvider>(
