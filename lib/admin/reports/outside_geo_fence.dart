...
import 'package:time_and_attendance/admin/provider/outside_geofence.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: <Widget>[
          ...
          ChangeNotifierProvider<OutsideGeofenceProvider>(
            create: (context) => OutsideGeofenceProvider(),
            child: Consumer<OutsideGeofenceProvider>(
                      ...
                      DataRow(
                        // List<DataCell> cells is required in every row
                          cells: [
                            ...
                            DataCell(Text(data.coordinates)),
