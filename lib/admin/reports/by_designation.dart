...
import 'package:time_and_attendance/admin/provider/by_designation.dart';
import 'package:flutter/material.dart';
...
class _ByDesignation extends State<ByDesignation> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: <Widget>[
          ...
          ChangeNotifierProvider<ByDesignationProvider>(
            create: (context) => ByDesignationProvider(),
            child: Consumer<ByDesignationProvider>(
